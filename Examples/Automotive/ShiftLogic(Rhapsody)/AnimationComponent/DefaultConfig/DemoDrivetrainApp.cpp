...
void DemoDrivetrainApp::init() {
    ...
    ONI_BEGIN_BROADCAST_MAP(double)
      ...
      ONI_OPER_LISTENER_IMPL(task_0100ms->itsDemoDrivetrainSubsystem, Engine, task_0100ms->itsDemoDrivetrainSubsystem->m_pSystemModel->itsEngine, handle_throttle)
      ONI_OPER_LISTENER_IMPL(task_0100ms->ShiftLogicController, Controller, task_0100ms->ShiftLogicController, handle_ThrottleData)
    ...
    ONI_BEGIN_BROADCAST_MAP(double)
      ONI_DATACOLLECTOR_IMPL(
        Name1, 
        task_0100ms->itsDemoDrivetrainSubsystem,
        task_0100ms->itsDemoDrivetrainSubsystem->itsEngine, 
        RPM)
      ONI_OPER_LISTENER_IMPL_DC(
        task_0100ms->itsEngineChart, 
        Chart, 
        task_0100ms->itsEngineChart, 
        handle_plotData)
    ONI_END_BROADCAST_MAP()
    ...
    ONI_BEGIN_BROADCAST_MAP(double)
      ...
      ONI_OPER_LISTENER_IMPL_DC(task_0100ms->ShiftLogicController, Controller, task_0100ms->ShiftLogicController, handle_SpeedData)
      ONI_OPER_LISTENER_IMPL_DC(task_0100ms->SpeedChart, Chart, task_0100ms->SpeedChart, handle_plotData)
    ONI_END_BROADCAST_MAP()
    
    ONI_BEGIN_BROADCAST_MAP(double)
      ONI_BROADCASTER_ENTRY(task_0100ms->itsDriver->brakes)
      ONI_OPER_LISTENER_IMPL(task_0100ms->itsDemoDrivetrainSubsystem, Vehicle5, task_0100ms->itsDemoDrivetrainSubsystem->m_pSystemModel->Car, handle_brakePedal)
    ONI_END_BROADCAST_MAP()
    
    ONI_BEGIN_BROADCAST_MAP(long)
      ONI_BROADCASTER_ENTRY(task_0100ms->itsDriver->shiftLever)
      ONI_OPER_LISTENER_IMPL(task_0100ms->ShiftLogicController, Controller, task_0100ms->ShiftLogicController, handle_ShiftLeverData)
    ONI_END_BROADCAST_MAP()
...
*/
    ...
    ONI_BEGIN_BROADCAST_MAP(long)
      ONI_BROADCASTER_ENTRY(task_0100ms->ShiftLogicController->Port_DC)
      ONI_OPER_LISTENER_IMPL(task_0100ms->itsDemoDrivetrainSubsystem, Actuator, task_0100ms->itsDemoDrivetrainSubsystem->m_pSystemModel->aDC, handle_shiftEvent)
    ONI_END_BROADCAST_MAP()
    
    ONI_BEGIN_BROADCAST_MAP(long)
      ONI_BROADCASTER_ENTRY(task_0100ms->ShiftLogicController->Port_OB)
      ONI_OPER_LISTENER_IMPL(task_0100ms->itsDemoDrivetrainSubsystem, Actuator, task_0100ms->itsDemoDrivetrainSubsystem->m_pSystemModel->aOB, handle_shiftEvent)
    ONI_END_BROADCAST_MAP()
    
    ONI_BEGIN_BROADCAST_MAP(long)
      ONI_BROADCASTER_ENTRY(task_0100ms->ShiftLogicController->Port_IOC)
      ONI_OPER_LISTENER_IMPL(task_0100ms->itsDemoDrivetrainSubsystem, Actuator, task_0100ms->itsDemoDrivetrainSubsystem->m_pSystemModel->aIOC, handle_shiftEvent)
    ONI_END_BROADCAST_MAP()
    
    ONI_BEGIN_BROADCAST_MAP(long)
      ONI_BROADCASTER_ENTRY(task_0100ms->ShiftLogicController->Port_POC)
      ONI_OPER_LISTENER_IMPL(task_0100ms->itsDemoDrivetrainSubsystem, Actuator, task_0100ms->itsDemoDrivetrainSubsystem->m_pSystemModel->aPOC, handle_shiftEvent)
    ONI_END_BROADCAST_MAP()
    
    ONI_BEGIN_BROADCAST_MAP(long)
      ONI_BROADCASTER_ENTRY(task_0100ms->ShiftLogicController->Port_FC)
      ONI_OPER_LISTENER_IMPL(task_0100ms->itsDemoDrivetrainSubsystem, Actuator, task_0100ms->itsDemoDrivetrainSubsystem->m_pSystemModel->aFC, handle_shiftEvent)
    ONI_END_BROADCAST_MAP()
    
    ONI_BEGIN_BROADCAST_MAP(long)
      ONI_BROADCASTER_ENTRY(task_0100ms->ShiftLogicController->Port_EngineStart)
      ONI_OPER_LISTENER_IMPL(task_0100ms->itsDemoDrivetrainSubsystem, Engine, task_0100ms->itsDemoDrivetrainSubsystem->m_pSystemModel->itsEngine, handle_Start)
    ONI_END_BROADCAST_MAP()
