// implementation for class junk200_app
#include "StdAfx.h"
#include "RtsOnTransmission.h"
#include <math.h>

#include "junk200_app.h"
// includes
#include "Throttle.h"
...
#include "Actuator.h"
#include "Engine.h"
void junk200_app::Fire_Tick(const double t)
{
...
void junk200_app::initSimulation()
{
...
void junk200_app::runSimulation()
{
...
HRESULT junk200_app::handle_tick(const double t)
{
...
void junk200_app::termSimulation()
{
...
bool junk200_app::Load(const BSTR filename)
{
...
void junk200_app::Save(const BSTR filename)
{
...
m_pModel->get_Eso(L"IOCGround", &m_IOCGround);
