...
HRESULT Car::GetAssociations(long** Assoc, long** Size, long* nSize)
{
...
void Car::handle_throttle(const double t, double* val)  
//}}SCG_OP_INFO
{
...
void Car::handle_RCShift(const double t, long* val)  
//}}SCG_OP_INFO
{
/***** Code between the BODY tags is automatically generated code. DO NOT DELETE or MODIFY. *****/
//{{SCG_OP_BODY
...
void Car::handle_LRBShift(const double t, long* val)  
//}}SCG_OP_INFO
{
/***** Code between the BODY tags is automatically generated code. DO NOT DELETE or MODIFY. *****/
//{{SCG_OP_BODY
...
void Car::handle_TCCShift(const double t, long* val)  
//}}SCG_OP_INFO
{
/***** Code between the BODY tags is automatically generated code. DO NOT DELETE or MODIFY. *****/
//{{SCG_OP_BODY
...
void Car::handle_OBShift(const double t, long* val)  
//}}SCG_OP_INFO
{
/***** Code between the BODY tags is automatically generated code. DO NOT DELETE or MODIFY. *****/
//{{SCG_OP_BODY
...
void Car::handle_DCShift(const double t, long* val)  
//}}SCG_OP_INFO
{
/***** Code between the BODY tags is automatically generated code. DO NOT DELETE or MODIFY. *****/
//{{SCG_OP_BODY
...
void Car::handle_IOCShift(const double t, long* val)  
//}}SCG_OP_INFO
{
/***** Code between the BODY tags is automatically generated code. DO NOT DELETE or MODIFY. *****/
//{{SCG_OP_BODY
...
void Car::handle_POCShift(const double t, long* val)  
//}}SCG_OP_INFO
{
/***** Code between the BODY tags is automatically generated code. DO NOT DELETE or MODIFY. *****/
//{{SCG_OP_BODY
...
void Car::handle_FCShift(const double t, long* val)  
//}}SCG_OP_INFO
{
/***** Code between the BODY tags is automatically generated code. DO NOT DELETE or MODIFY. *****/
//{{SCG_OP_BODY
...
void Car::handle_brakeTorque(const double t, double* val)
{
  myCar->handle_brakeTorque(t, val);
}

void Car::handle_Start(const double t, long *val)
{
  EngineWithSpeed->handle_Start(t, val); 
}


void Car::Save(FILE* fs)
{
