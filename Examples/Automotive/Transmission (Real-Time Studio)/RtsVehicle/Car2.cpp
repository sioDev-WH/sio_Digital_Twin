...
HRESULT Car2::GetAssociations(long** Assoc, long** Size, long* nSize)
{
...
void Car2::handle_throttle(const double t, double* val)  
{
  EngineWithSpeed->handle_throttle(t, val);
}                     

void Car2::handle_RCShift(const double t, long* val)  
{
  aRC->handle_shiftEvent(t, val);
}                     

void Car2::handle_LRBShift(const double t, long* val)  
{
  aLRB->handle_shiftEvent(t, val);
}                     

void Car2::handle_TCCShift(const double t, long* val)  
{
//aTCC->handle_shiftEvent(t, val);
}                     

void Car2::handle_OBShift(const double t, long* val)  
{
  aOB->handle_shiftEvent(t, val);
}                     

void Car2::handle_DCShift(const double t, long* val)  
{
  aDC->handle_shiftEvent(t, val);
}                     

void Car2::handle_IOCShift(const double t, long* val)  
{
  aIOC->handle_shiftEvent(t, val);
}                     

void Car2::handle_POCShift(const double t, long* val)  
{
  aPOC->handle_shiftEvent(t, val);
}                     

void Car2::handle_FCShift(const double t, long* val)  
{
  aFC->handle_shiftEvent(t, val);
}                     

void Car2::handle_brakeTorque(const double t, double* val)
{
  Car->handle_brakeTorque(t, val);
}

void Car2::handle_Start(const double t, long *val)
{
