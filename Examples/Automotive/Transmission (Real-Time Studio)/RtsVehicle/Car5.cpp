...
HRESULT Car5::GetAssociations(long** Assoc, long** Size, long* nSize)
{

long nAssoc;
long i;
/*
  0 ADD_LOCAL_ESO(Spring)
  1 ADD_LOCAL_ESO(Damper)
  2 ADD_LOCAL_ESO(EngineWithSpeed)
  3 ADD_LOCAL_ESO(aRC)
  4 ADD_LOCAL_ESO(RC)
  5 ADD_LOCAL_ESO(aLRB)
  6 ADD_LOCAL_ESO(GLRB)
  7 ADD_LOCAL_ESO(LRB)
  8 ADD_LOCAL_ESO(GOB)
  9 ADD_LOCAL_ESO(aOB)
 10 ADD_LOCAL_ESO(OB)
 11 ADD_LOCAL_ESO(aDC)
 12 ADD_LOCAL_ESO(DC)
 13 ADD_LOCAL_ESO(aIOC)
 14 ADD_LOCAL_ESO(IOC)
 15 ADD_LOCAL_ESO(GPOC)
 16 ADD_LOCAL_ESO(aPOC)
 17 ADD_LOCAL_ESO(POC)
 18 ADD_LOCAL_ESO(aFC)
 19 ADD_LOCAL_ESO(FC)
 20 ADD_LOCAL_ESO(GIOC)
 21 ADD_LOCAL_ESO(Car)
 22 ADD_LOCAL_ESO(GearBox)
#if include_torque_converter
 23 ADD_LOCAL_ESO(Converter)
#endif
*/

const long assoc[] =
{
  0, 1,      21, 0,  // p is connector 0
  22, 3,      0, 0,
  1, 0,      21, 0,  // p is connector 0
  22, 3,      1, 1,
#if include_torque_converter
  2, 0,      23, 1,
  23, 0,     4, 2,
...
void Car5::handle_throttle(const double t, double* val)  
{
  EngineWithSpeed->handle_throttle(t, val);
}                     

void Car5::handle_RCShift(const double t, long* val)  
{
  aRC->handle_shiftEvent(t, val);
}                     

void Car5::handle_LRBShift(const double t, long* val)  
{
  aLRB->handle_shiftEvent(t, val);
}                     

void Car5::handle_TCCShift(const double t, long* val)  
{
//aTCC->handle_shiftEvent(t, val);
}                     

void Car5::handle_OBShift(const double t, long* val)  
{
  aOB->handle_shiftEvent(t, val);
}                     

void Car5::handle_DCShift(const double t, long* val)  
{
  aDC->handle_shiftEvent(t, val);
}                     

void Car5::handle_IOCShift(const double t, long* val)  
{
  aIOC->handle_shiftEvent(t, val);
}                     

void Car5::handle_POCShift(const double t, long* val)  
{
  aPOC->handle_shiftEvent(t, val);
}                     

void Car5::handle_FCShift(const double t, long* val)  
{
  aFC->handle_shiftEvent(t, val);
}                     

void Car5::handle_brakeTorque(const double t, double* val)
{
  Car->handle_brakePedal(t, val);
}

void Car5::handle_Start(const double t, long *val)
{
