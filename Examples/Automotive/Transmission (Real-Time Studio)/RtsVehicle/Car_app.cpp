// implementation for class Car_app
#include "StdAfx.h"
...
void Car_app::Fire_Tick(const double t)
{
...
HRESULT Car_app::handle_tick(const double t)
{
  sim_time = t;
  printData(t);
...
void Car_app::printData(const double t)
{
  long i;
...
double Car_app::getSpeed(const double t)
{
  double val;
...
double Car_app::getdSpeed(const double t)
{
  double val;
  // NOTE: could add a couple lines to get this variable by name, but this was much easier.
...
double Car_app::getRPM(const double t)
{
  double val;
  // NOTE: could add a couple lines to get this variable by name, but this was much easier.
...
void Car_app::set_throttle(const double t, double* val)
{
  Accelerator->setPosition(t, val);
}


void Car_app::set_brake(const double t, double* val)
{
  Brake->setPosition(t, val);
}

void Car_app::runSimulation()
{
  HRESULT hr = S_OK;
...
bool Car_app::Load(BSTR filename)
{
...
void Car_app::Save(BSTR filename)
{
  CComBSTR bstrName = filename;
  CComBSTR bstrControlName = filename;
  bstrName.Append(L".bin");
...
void Car_app::ReverseControllerShiftTiming()
{
  AODController->bReverse = true;
}

double Car_app::get_LastTime()
{
  double val;
...
double Car_app::get_AccelerationDot(const double t)
{
  double val;
  // NOTE: could add a couple lines to get this variable by name, but this was much easier.
...
double Car_app::get_Acceleration(const double t)
{
  double val;
  // NOTE: could add a couple lines to get this variable by name, but this was much easier.
...
void Car_app::put_ThrottlePosition(const double t, double* val)
{
  Accelerator->setPosition(t, val);
}

void Car_app::put_BrakePosition(const double t, double* val)
{
  Brake->setPosition(t, val);
}

void Car_app::put_shiftTiming(bool bUpshift, long iIndex, double val)
{
  if (bUpshift)
