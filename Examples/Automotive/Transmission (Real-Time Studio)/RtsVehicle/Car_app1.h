...
class RTSONTRANSMISSION_API Car_app1 : public COnModelBase
{
public:
Car_app1();
virtual ~Car_app1();
...
#if _use_spring_damper
COnListener<Car1, long>* CarWithDriveTrain_handle_OBShift;
COnListener<Car1, long>* CarWithDriveTrain_handle_DCShift;
COnListener<Car1, long>* CarWithDriveTrain_handle_TCCShift;
COnListener<Car1, long>* CarWithDriveTrain_handle_IOCShift;
COnListener<Car1, long>* CarWithDriveTrain_handle_POCShift;
COnListener<Car1, long>* CarWithDriveTrain_handle_FCShift;
COnListener<Car1, long>* CarWithDriveTrain_handle_LRBShift;
COnListener<Car1, long>* CarWithDriveTrain_handle_RCShift;
COnListener<Car1, double>* CarWithDriveTrain_handle_brakeTorque;
COnListener<Car1, double>* CarWithDriveTrain_handle_throttle;
#else
