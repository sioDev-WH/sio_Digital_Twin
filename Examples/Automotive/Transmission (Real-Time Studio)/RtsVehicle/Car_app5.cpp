// implementation for class Car_app5
#include "StdAfx.h"
...
void Car_app5::Fire_Tick(const double t)
{
...
HRESULT Car_app5::handle_tick(const double t)
{
  sim_time = t;
  setTime(t);
  receive();
...
void Car_app5::printData(const double t)
{
  long i;
...
double Car_app5::getSpeed(const double t)
{
  double val;
...
double Car_app5::getdSpeed(const double t)
{
  double val;
  // NOTE: could add a couple lines to get this variable by name, but this was much easier.
...
double Car_app5::getRPM(const double t)
{
  double val;
  // NOTE: could add a couple lines to get this variable by name, but this was much easier.
...
void Car_app5::set_throttle(const double t, double* val)
{
  Accelerator->setPosition(t, val);
}


void Car_app5::set_brake(const double t, double* val)
{
  Brake->setPosition(t, val);
}

void Car_app5::runSimulation()
{
  HRESULT hr = S_OK;
...
AODController_handle_ShiftLeverData->setOwner(AODController);
AODController->AddListener(AODController_handle_ShiftLeverData);
...
AODController_handle_ThrottleData->setOwner(AODController);
AODController->AddListener(AODController_handle_ThrottleData);
Accelerator->positionPort->Advise(AODController_handle_ThrottleData);

#if _use_spring_damper
CarWithDriveTrain_handle_OBShift = new COnListener<Car5, long>(m_pUMLModel, &Car5::handle_OBShift);
CarWithDriveTrain_handle_OBShift->AddRef();
CarWithDriveTrain_handle_OBShift->setOwner(this);
AODController->Port_7->Advise(CarWithDriveTrain_handle_OBShift);
CarWithDriveTrain_handle_DCShift = new COnListener<Car5, long>(m_pUMLModel, &Car5::handle_DCShift);
CarWithDriveTrain_handle_DCShift->AddRef();
CarWithDriveTrain_handle_DCShift->setOwner(this);
AODController->Port_6->Advise(CarWithDriveTrain_handle_DCShift);
CarWithDriveTrain_handle_TCCShift = new COnListener<Car5, long>(m_pUMLModel, &Car5::handle_TCCShift);
CarWithDriveTrain_handle_TCCShift->AddRef();
CarWithDriveTrain_handle_TCCShift->setOwner(this);
//AODController->Port_5->Advise(CarWithDriveTrain_handle_TCCShift);
CarWithDriveTrain_handle_IOCShift = new COnListener<Car5, long>(m_pUMLModel, &Car5::handle_IOCShift);
CarWithDriveTrain_handle_IOCShift->AddRef();
CarWithDriveTrain_handle_IOCShift->setOwner(this);
AODController->Port_4->Advise(CarWithDriveTrain_handle_IOCShift);
CarWithDriveTrain_handle_POCShift = new COnListener<Car5, long>(m_pUMLModel, &Car5::handle_POCShift);
CarWithDriveTrain_handle_POCShift->AddRef();
CarWithDriveTrain_handle_POCShift->setOwner(this);
AODController->Port_3->Advise(CarWithDriveTrain_handle_POCShift);
CarWithDriveTrain_handle_FCShift = new COnListener<Car5, long>(m_pUMLModel, &Car5::handle_FCShift);
CarWithDriveTrain_handle_FCShift->AddRef();
CarWithDriveTrain_handle_FCShift->setOwner(this);
AODController->Port_2->Advise(CarWithDriveTrain_handle_FCShift);
CarWithDriveTrain_handle_LRBShift = new COnListener<Car5, long>(m_pUMLModel, &Car5::handle_LRBShift);
CarWithDriveTrain_handle_LRBShift->AddRef();
CarWithDriveTrain_handle_LRBShift->setOwner(this);
AODController->Port_1->Advise(CarWithDriveTrain_handle_LRBShift);
CarWithDriveTrain_handle_RCShift = new COnListener<Car5, long>(m_pUMLModel, &Car5::handle_RCShift);
CarWithDriveTrain_handle_RCShift->AddRef();
CarWithDriveTrain_handle_RCShift->setOwner(this);
AODController->Port_0->Advise(CarWithDriveTrain_handle_RCShift);
CarWithDriveTrain_handle_brakeTorque = new COnListener<Car5, double>(m_pUMLModel, &Car5::handle_brakeTorque);
CarWithDriveTrain_handle_brakeTorque->AddRef();
CarWithDriveTrain_handle_brakeTorque->setOwner(this);
Brake->positionPort->Advise(CarWithDriveTrain_handle_brakeTorque);
CarWithDriveTrain_handle_throttle = new COnListener<Car5, double>(m_pUMLModel, &Car5::handle_throttle);
CarWithDriveTrain_handle_throttle->AddRef();
CarWithDriveTrain_handle_throttle->setOwner(this);
...
bool Car_app5::Load(BSTR filename)
{
...
void Car_app5::Save(BSTR filename)
{
  CComBSTR bstrName = filename;
  CComBSTR bstrControlName = filename;
  bstrName.Append(L".bin");
...
void Car_app5::ReverseControllerShiftTiming()
{
  AODController->bReverse = true;
}

double Car_app5::get_LastTime()
{
  double val;
...
double Car_app5::get_AccelerationDot(const double t)
{
  double val;
  // NOTE: could add a couple lines to get this variable by name, but this was much easier.
...
double Car_app5::get_Acceleration(const double t)
{
  double val;
  // NOTE: could add a couple lines to get this variable by name, but this was much easier.
...
void Car_app5::put_ThrottlePosition(const double t, double* val)
{
  Accelerator->setPosition(t, val);
}

void Car_app5::put_BrakePosition(const double t, double* val)
{
  Brake->setPosition(t, val);
}

void Car_app5::put_shiftTiming(bool bUpshift, long iIndex, double val)
{
  if (bUpshift)
