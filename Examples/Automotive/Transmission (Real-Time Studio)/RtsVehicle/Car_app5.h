...
class RTSONTRANSMISSION_API Car_app5 : public COnModelBase
{
public:
Car_app5();
virtual ~Car_app5();
...
#if _use_spring_damper
COnListener<Car5, long>* CarWithDriveTrain_handle_OBShift;
COnListener<Car5, long>* CarWithDriveTrain_handle_DCShift;
COnListener<Car5, long>* CarWithDriveTrain_handle_TCCShift;
COnListener<Car5, long>* CarWithDriveTrain_handle_IOCShift;
COnListener<Car5, long>* CarWithDriveTrain_handle_POCShift;
COnListener<Car5, long>* CarWithDriveTrain_handle_FCShift;
COnListener<Car5, long>* CarWithDriveTrain_handle_LRBShift;
COnListener<Car5, long>* CarWithDriveTrain_handle_RCShift;
COnListener<Car5, double>* CarWithDriveTrain_handle_brakeTorque;
COnListener<Car5, double>* CarWithDriveTrain_handle_throttle;
#else
