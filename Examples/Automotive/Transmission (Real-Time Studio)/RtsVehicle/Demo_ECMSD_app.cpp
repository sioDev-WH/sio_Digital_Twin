// implementation for class Demo_ECMSD_app
#include "StdAfx.h"
...
void Demo_ECMSD_app::Fire_Tick(const double t)
{
...
void Demo_ECMSD_app::initSimulation()
{
...
void Demo_ECMSD_app::runSimulation()
{
...
HRESULT Demo_ECMSD_app::handle_tick(const double t)
{
...
void Demo_ECMSD_app::termSimulation()
{
...
bool Demo_ECMSD_app::Load(const BSTR filename)
{
...
void Demo_ECMSD_app::Save(const BSTR filename)
{
...
m_pModel->get_Eso(L"aSpring", &m_aSpring);
m_pModel->get_Eso(L"Damper", &m_Damper);
