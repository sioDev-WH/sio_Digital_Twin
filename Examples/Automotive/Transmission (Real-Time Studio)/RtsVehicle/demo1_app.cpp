// implementation for class demo1_app
#include "StdAfx.h"
...
void demo1_app::Fire_Tick(const double t)
{
...
HRESULT demo1_app::handle_tick(const double t)
{
...
bool demo1_app::Load(const BSTR filename)
{
...
void demo1_app::Save(const BSTR filename)
{
