// implementation for class demo1_app1
#include "StdAfx.h"
#include "RtsOnTransmission.h"
#include <math.h>

#include "demo1_app1.h"
// includes
#include "Throttle.h"
...
void demo1_app1::Fire_Tick(const double t)
{
...
void demo1_app1::initSimulation()
{
...
HRESULT demo1_app1::handle_tick(const double t)
{
...
void demo1_app1::termSimulation()
{
...
bool demo1_app1::Load(const BSTR filename)
{
...
void demo1_app1::Save(const BSTR filename)
{
