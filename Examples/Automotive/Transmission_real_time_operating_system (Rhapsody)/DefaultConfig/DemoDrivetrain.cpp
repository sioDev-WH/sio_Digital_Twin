...
//!	Generated Date	: Tue, 21, Jan 2003  
	File Path	: AnimationComponent\DefaultConfig\DemoDrivetrain.cpp
*********************************************************************/
...
//#[ ignore 
#define Application_DemoDrivetrain_DemoDrivetrain_SERIALIZE OM_NO_OP


#define Application_DemoDrivetrain_GetAssociations_SERIALIZE OM_NO_OP


#define Application_DemoDrivetrain_InitEsos_SERIALIZE OM_NO_OP


#define Application_DemoDrivetrain_Load_SERIALIZE OM_NO_OP


#define Application_DemoDrivetrain_Save_SERIALIZE OM_NO_OP


#define Application_DemoDrivetrain_clean_SERIALIZE OM_NO_OP


#define Application_DemoDrivetrain_init_SERIALIZE OM_NO_OP
//#]
...
DemoDrivetrain::DemoDrivetrain() {
    NOTIFY_CONSTRUCTOR(DemoDrivetrain, DemoDrivetrain(), 0, Application_DemoDrivetrain_DemoDrivetrain_SERIALIZE);
    Car = NULL;
    DC = NULL;
    FC = NULL;
    IOC = NULL;
...
DemoDrivetrain::~DemoDrivetrain() {
    NOTIFY_DESTRUCTOR(~DemoDrivetrain, TRUE);
    //#[ operation ~DemoDrivetrain() 
...
HRESULT DemoDrivetrain::GetAssociations(long**  Assoc, long**  Size, long*  nSize) {
    NOTIFY_OPERATION(GetAssociations, GetAssociations(long**,long**,long*), 0, Application_DemoDrivetrain_GetAssociations_SERIALIZE);
...
HRESULT DemoDrivetrain::InitEsos() {
    NOTIFY_OPERATION(InitEsos, InitEsos(), 0, Application_DemoDrivetrain_InitEsos_SERIALIZE);
    //#[ operation InitEsos() 
...
bool DemoDrivetrain::Load(FILE*  fs) {
    NOTIFY_OPERATION(Load, Load(FILE*), 0, Application_DemoDrivetrain_Load_SERIALIZE);
    //#[ operation Load(FILE*) 
...
void DemoDrivetrain::Save(FILE*  fs) {
    NOTIFY_OPERATION(Save, Save(FILE*), 0, Application_DemoDrivetrain_Save_SERIALIZE);
    //#[ operation Save(FILE*) 
...
void DemoDrivetrain::clean() {
    NOTIFY_OPERATION(clean, clean(), 0, Application_DemoDrivetrain_clean_SERIALIZE);
    //#[ operation clean() 
...
void DemoDrivetrain::init() {
    NOTIFY_OPERATION(init, init(), 0, Application_DemoDrivetrain_init_SERIALIZE);
    //#[ operation init() 
...
void DemoDrivetrain::cleanUpRelations() {
    if(Car != NULL)
        {
...
void OMAnimatedDemoDrivetrain::serializeRelations(AOMSRelations*  aomsRelations) const {
...
IMPLEMENT_META(DemoDrivetrain, Application, FALSE, OMAnimatedDemoDrivetrain)
#endif // _OMINSTRUMENT
