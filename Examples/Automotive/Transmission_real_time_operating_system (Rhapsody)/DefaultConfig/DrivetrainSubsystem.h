...
//!	Generated Date	: Sun, 19, Jan 2003  
	File Path	: AnimationComponent\DefaultConfig\DrivetrainSubsystem.h
*********************************************************************/
...
//----------------------------------------------------------------------------
// DrivetrainSubsystem.h                                                                  
//----------------------------------------------------------------------------
class Drivetrain;

#ifdef _OMINSTRUMENT
class OMAnimatedDrivetrainSubsystem;
#endif // _OMINSTRUMENT


//## class DrivetrainSubsystem 
class DrivetrainSubsystem : public IOnModelExecEvents, public COnModelBase {
...
#ifdef _OMINSTRUMENT
    friend  class OMAnimatedDrivetrainSubsystem;
#endif // _OMINSTRUMENT
...
public :
    ...
    //## auto_generated 
    void setItsCar(IIsDaeEsoCImpl*  p_itsCar);
...
public :
    ...
    IIsDaeEsoCImpl* itsCar;		//## attribute itsCar 
...
public :
    ...
    Drivetrain* m_pSystemModel;		//## link m_pSystemModel 
...
#ifdef _OMINSTRUMENT
//## ignore 
class OMAnimatedDrivetrainSubsystem : virtual public AOMInstance {

    
    DECLARE_META(DrivetrainSubsystem, OMAnimatedDrivetrainSubsystem)
