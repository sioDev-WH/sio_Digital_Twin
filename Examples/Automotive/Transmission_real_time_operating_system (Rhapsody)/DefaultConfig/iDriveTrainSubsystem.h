...
//!	Generated Date	: Tue, 21, Jan 2003  
	File Path	: AnimationComponent\DefaultConfig\iDriveTrainSubsystem.h
*********************************************************************/


#ifndef iDriveTrainSubsystem_H 

#define iDriveTrainSubsystem_H 
...
//----------------------------------------------------------------------------
// iDriveTrainSubsystem.h                                                                  
//----------------------------------------------------------------------------
class iDriveTrain;

#ifdef _OMINSTRUMENT
class OMAnimatediDriveTrainSubsystem;
#endif // _OMINSTRUMENT


//## class iDriveTrainSubsystem 
class iDriveTrainSubsystem : public IOnModelExecEvents, public COnModelBase {
...
#ifdef _OMINSTRUMENT
    friend  class OMAnimatediDriveTrainSubsystem;
#endif // _OMINSTRUMENT
...
public :
    ...
    iDriveTrain* m_pSystemModel;		//## link m_pSystemModel 
...
#ifdef _OMINSTRUMENT
//## ignore 
class OMAnimatediDriveTrainSubsystem : virtual public AOMInstance {

    
    DECLARE_META(iDriveTrainSubsystem, OMAnimatediDriveTrainSubsystem)
