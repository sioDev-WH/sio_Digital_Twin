...
//!	Generated Date	: Mon, 13, Oct 2003  
	File Path	: DefaultComponent\DefaultConfig\CChartDlg.cpp
*********************************************************************/
...
#define DisplayPkg_CChartDlg_GetPosition_SERIALIZE OM_NO_OP


#define DisplayPkg_CChartDlg_Move_SERIALIZE OM_NO_OP


#define DisplayPkg_CChartDlg_SetCaption_SERIALIZE OM_NO_OP


#define DisplayPkg_CChartDlg_SetLegends_SERIALIZE OM_NO_OP


#define DisplayPkg_CChartDlg_Show_SERIALIZE OM_NO_OP


#define DisplayPkg_CChartDlg_addSeries_SERIALIZE OM_NO_OP
...
#define DisplayPkg_CChartDlg_initPlot_SERIALIZE OM_NO_OP


#define DisplayPkg_CChartDlg_plotData_SERIALIZE OM_NO_OP


#define DisplayPkg_CChartDlg_plotSeriesData_SERIALIZE OM_NO_OP
//#]
...
void CChartDlg::GetPosition(int * x, int * y, int * nWidth, int * nHeight) {
    NOTIFY_OPERATION(GetPosition, GetPosition(int * ,int * ,int * ,int * ), 0, DisplayPkg_CChartDlg_GetPosition_SERIALIZE);
...
void CChartDlg::Move(const int x, const int y, const int nWidth, const int nHeight) {
    NOTIFY_OPERATION(Move, Move(const int ,const int ,const int ,const int ), 0, DisplayPkg_CChartDlg_Move_SERIALIZE);
...
void CChartDlg::SetCaption(LPCTSTR szCaption) {
    NOTIFY_OPERATION(SetCaption, SetCaption(LPCTSTR ), 0, DisplayPkg_CChartDlg_SetCaption_SERIALIZE);
...
void CChartDlg::SetLegends(const long  nSeries, BSTR *  pLegend) {
    NOTIFY_OPERATION(SetLegends, SetLegends(const long ,BSTR *), 0, DisplayPkg_CChartDlg_SetLegends_SERIALIZE);
...
void CChartDlg::addSeries(const bool bPoint, BSTR Name) {
    NOTIFY_OPERATION(addSeries, addSeries(const bool ,BSTR ), 0, DisplayPkg_CChartDlg_addSeries_SERIALIZE);
...
void CChartDlg::initPlot(const long numberOfSeries, const bool bPoint, BSTR * pNames) {
    NOTIFY_OPERATION(initPlot, initPlot(const long ,const bool ,BSTR * ), 0, DisplayPkg_CChartDlg_initPlot_SERIALIZE);
...
void CChartDlg::plotData(const double time, const double * vars, const long count) {
    NOTIFY_OPERATION(plotData, plotData(const double ,const double * ,const long ), 0, DisplayPkg_CChartDlg_plotData_SERIALIZE);
...
void CChartDlg::plotSeriesData(const double time, double  var) {
    NOTIFY_OPERATION(plotSeriesData, plotSeriesData(const double ,double), 0, DisplayPkg_CChartDlg_plotSeriesData_SERIALIZE);
