...
//!	Generated Date	: Mon, 13, Oct 2003  
	File Path	: DefaultComponent\DefaultConfig\Units.cpp
*********************************************************************/
...
double Units::getBias() const {
    return bias;
}

void Units::setBias(double  p_bias) {
    bias = p_bias;
}

char Units::getName(int  i1) const {
    return name[i1];
}

void Units::setName(int  i1, char  p_name) {
    name[i1] = p_name;
}

double Units::getSlope() const {
    return slope;
}

void Units::setSlope(double  p_slope) {
    slope = p_slope;
}

UNITS_T Units::getType() const {
    return type;
}

void Units::setType(UNITS_T  p_type) {
    type = p_type;
}
