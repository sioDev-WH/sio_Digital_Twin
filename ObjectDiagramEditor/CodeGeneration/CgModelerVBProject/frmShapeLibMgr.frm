...
Begin VB.Form frmShapeLibMgr 
   ...
   Begin VB.PictureBox picMore 
      ...
      Visible         =   0   'False
      Width           =   3405
      Begin VB.Frame frmDefaultProperties 
         ...
         Begin VB.ListBox lbScaleModeDST 
            Height          =   1035
            ItemData        =   "frmShapeLibMgr.frx":0469
            Left            =   90
            List            =   "frmShapeLibMgr.frx":047C
            TabIndex        =   42
            Top             =   1410
            Width           =   1515
         End
         ...
         End
      End
      Begin VB.Frame frmMemberShapes 
...
Private Sub btnCreateLibrary_Click()
  ...
  End If
  strEmptyLibrary = strSysPath & "\CG.cgl"
  ...
  If bPromptEmpty Then
    MsgBox "Cannot find the master CG.cgl Library. Please locate now!", vbExclamation
    strEmptyLibrary = strSysPath & "\CG.cgl"
    If Not FileExists(strEmptyLibrary) Then
      strTemp = "CG.cgl"
      '
      strTmp = m_strCurPath
      bMaster = LocateMaster(strEmptyLibrary, strTemp, "Locate master CG.cgl file")
      m_strCurPath = strTmp
      '
      If bMaster Then
        If Len(strTemp) > 0 Then
  ...
  If IsLibraryAttached(strNewLibrary) Or FileExists(strNewLibrary) Then
    ...
    Exit Sub
  End If
  If strNewLibrary = "CG.cgl" Then
    MsgBox " 'CG' is the same name as the master library, please use another name.", , "Shape Library Manager"
    Exit Sub
  End If
...
Private Sub form_Resize()
  ...
  '  picMore.Left = ShapeGe.Left + ShapeGe.Width + 130
     picMore.Left = frmDestination.Width + 200
    'Me.Width = picMore.Left + picMore.Width + 140
     Me.Width = frmDestination.Width + 400 + picMore.Width
  ...
  Else
    ...
    Me.Width = frmDestination.Width + 1300
  End If
  btnExit.Left = Abs(Me.Width - btnExit.Width - 150)
  btnExit.Top = 250
End Sub
...
Private Sub ShowSourceShape(nDX As Integer, strShapeFolderName As String, strLibName As String)
  ...
  SourceShapeGe.UsePictureColor = True
