...
Begin VB.Form frmUDItemDefs 
   ...
   Begin TabDlg.SSTab tabAssociation 
      ...
      Tab(0).Control(3)=   "ucUMLTreeView"
      Tab(0).Control(3).Enabled=   0   'False
      Tab(0).Control(4)=   "lstObjectDefinitions1"
...
Private Sub btnCreateItem_Click()
  ...
  strName = ucUMLTreeView.ClassName & "Link"
  ...
  If Not m_UDIDefMgr Is Nothing Then
    ...
    Do
        ...
        If pDef Is Nothing Then Exit Do
        strName = strNameOrig & "_" & CStr(j)
        j = j + 1
    Loop
...
Error_Handler:
    gMsgWnd.LogMessage "Shape Managment dialog load error: " & Err.Description
End Sub
...
Error_Handler:
    gMsgWnd.LogMessage "Shape Managment dialog initialization error: " & Err.Description
End Sub
  ...
  If idx >= 0 Then
    ...
    If Not m_UDIDefMgr Is Nothing Then
      ...
      If Not objDef Is Nothing Then
        ...
        If ucUMLTreeView.ProjectName <> objDef.ProjectName Then ucUMLTreeView.ProjectName = objDef.ProjectName
        If ucUMLTreeView.PackagesName <> objDef.packageName Then ucUMLTreeView.PackagesName = objDef.packageName
        If ucUMLTreeView.ClassName <> objDef.ClassName Then ucUMLTreeView.ClassName = objDef.ClassName
      Else
...
Private Sub lstObjectDefinitions2_Click()
  ...
  If Not bFound Then    'Clear current selection in tree
    For Each aNode In tvwShapes.nodes
...
Private Sub mnuObjectDefs_Click(Index As Integer)
  ...
  If idx >= 0 Then
    ...
    Select Case Index
      Case 0
        DoObjectDefRename szObjDefName, idx
      Case 1
...
Private Sub DoObjectDefRename(szObjDefName As String, Index As Long)
  Dim strNewName As String
  
  On Error Resume Next
  If Not m_UDIDefMgr Is Nothing Then
    strNewName = m_UDIDefMgr.RenameUDIDef(szObjDefName)
    If strNewName <> "" Then
        lstObjectDefinitions1.List(Index) = strNewName
        lstObjectDefinitions2.List(Index) = strNewName
        lstObjectDefinitions1.Refresh
        lstObjectDefinitions2.Refresh
        m_UDIDefMgr.RenameUDI szObjDefName, strNewName
        m_UDIDefMgr.IsDirty = True
    End If
  End If
End Sub
...
Error_Handler:
    gMsgWnd.LogMessage "Object deletion error: " & Err.Description
End Sub
