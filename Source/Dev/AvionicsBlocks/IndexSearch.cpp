...
// Use in system/controller classes
// Add a method that loops to locate all blends of scheduled matrices of a dynamic system/controller (A,B,C,D)
...
// Support for fixed-point arithmetic processing
