...
Guidance.obj : Guidance.cpp Guidance.h    Default.h myFactory.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Guidance.obj" "Guidance.cpp" 


myFactory.obj : myFactory.cpp myFactory.h    Default.h Guidance.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"myFactory.obj" "myFactory.cpp" 


Default.obj : Default.cpp Default.h    Guidance.h myFactory.h 
	$(CREATE_OBJ_DIR)
...
clean:
	@echo Cleanup
	if exist Guidance.obj erase Guidance.obj
	if exist myFactory.obj erase myFactory.obj
