...
//!	Generated Date	: Tue, 10, Dec 2002  
	File Path	: AnimationComponent\DefaultConfig\AeroCoeff.cpp
*********************************************************************/
...
void OMAnimatedAeroCoeff::serializeAttributes(AOMSAttributes*  aomsAttributes) const {
}

void OMAnimatedAeroCoeff::serializeRelations(AOMSRelations*  aomsRelations) const {
}

IMPLEMENT_META(AeroCoeff, GuidancePkg, FALSE, OMAnimatedAeroCoeff)
#endif // _OMINSTRUMENT
