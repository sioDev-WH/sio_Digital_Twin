...
//!	Generated Date	: Tue, 10, Dec 2002  
	File Path	: AnimationComponent\DefaultConfig\AeroCoeff.h
*********************************************************************/
...
#ifdef _OMINSTRUMENT
    friend  class OMAnimatedAeroCoeff;
#endif // _OMINSTRUMENT
...
#ifdef _OMINSTRUMENT
//## ignore 
class OMAnimatedAeroCoeff : virtual public AOMInstance {

    
    DECLARE_META(AeroCoeff, OMAnimatedAeroCoeff)
