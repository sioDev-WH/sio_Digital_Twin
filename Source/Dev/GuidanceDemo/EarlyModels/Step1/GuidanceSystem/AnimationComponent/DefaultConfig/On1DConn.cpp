...
//!	Generated Date	: Tue, 10, Dec 2002  
	File Path	: AnimationComponent\DefaultConfig\On1DConn.cpp
*********************************************************************/
...
void OMAnimatedOn1DConn::serializeAttributes(AOMSAttributes*  aomsAttributes) const {
}

void OMAnimatedOn1DConn::serializeRelations(AOMSRelations*  aomsRelations) const {
}

IMPLEMENT_META(On1DConn, GuidancePkg, FALSE, OMAnimatedOn1DConn)
#endif // _OMINSTRUMENT
