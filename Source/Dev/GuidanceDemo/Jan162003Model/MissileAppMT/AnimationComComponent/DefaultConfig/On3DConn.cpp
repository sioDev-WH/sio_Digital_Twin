...
//!	Generated Date	: Thu, 16, Jan 2003  
	File Path	: AnimationComComponent\DefaultConfig\On3DConn.cpp
*********************************************************************/
...
long On3DConn::getIdx_var_Fx() const {
    return idx_var_Fx;
}
...
long On3DConn::getIdx_var_Fz() const {
    return idx_var_Fz;
}
...
long On3DConn::getIdx_var_My() const {
    return idx_var_My;
}
...
long On3DConn::getIdx_var_q() const {
    return idx_var_q;
}
...
long On3DConn::getIdx_var_u() const {
    return idx_var_u;
}
...
long On3DConn::getIdx_var_w() const {
    return idx_var_w;
}
...
On3DConn * *  On3DConn::getM_TypedEsos() const {
    return m_TypedEsos;
}
...
double On3DConn::getTmpVal() const {
    return tmpVal;
}
