...
void Create1VarScheduledMatrix();
void Create2VarScheduledMatrix();
...
typedef double T;
typedef ScheduledMatrix<T,NVARS,NTABLES> SM;
...
void main(){
	...
	Create1VarScheduledMatrix();
	Create2VarScheduledMatrix();
