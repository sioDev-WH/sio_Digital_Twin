*
*     C G B M V  Example Program Text
...
*
      ...
      complex*8        a(mmax,nmax), x(xmax), y(ymax)
      integer          i, j, ku1, kl1 
*       Intrinsic Functions
      intrinsic        abs
*       External Subroutines 
      external         CGBMV, PrintVectorC, PrintBandArrayC
*
*       Executable Statements                           
*
      print*
      print*, '   C G B M V  EXAMPLE PROGRAM'
*
...
*       Print input data
      ...
      call PrintBandArrayC(0,kl,ku,m,n,a,lda,'A')
*
