*
*     Z D O T C I  Example Program Text
...
*       External Function 
      external            ZDOTCI, MaxValue, PrintVectorZ
      complex*16          ZDOTCI
*
*       Executable Statements 
*
      print*
      print*,'   Z D O T C I  EXAMPLE PROGRAM'
*
...
*
*       Call ZDOTCI function
      res = ZDOTCI(n,x,indx,y)
*
      print*
      print*, '     OUTPUT DATA'
      print 102, res
*
 ...
 102  format(11x,'ZDOTCI = (',f6.2,',',f6.2,' )')
      stop
      end
