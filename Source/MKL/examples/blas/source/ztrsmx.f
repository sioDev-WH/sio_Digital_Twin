*
*     Z T R S M  Example Program Text
...
*      External Subroutines 
      external           ZTRSM, PrintArrayZ
*
*      Executable Statements 
*
      print*
      print*,'   Z T R S M  EXAMPLE PROGRAM'
...
*      Call ZTRSM subroutine
      call ZTRSM(side, uplo, transa, diag, m, n, alpha, a, lda,
     $           b, ldb)
*
*       Print output data
      print*
      print*, '     OUTPUT DATA'
      call PrintArrayZ(1, 0, m, n, b, ldb, 'B')
*
 100  format(4(a1,1x))
