...
void GetInputData(FILE*, int*, int*, int*, int*, int*, int*, 
...
/*       Get input data                                       */
      ...
      GetBandArrayZ(in_file, &order, kl, ku, m, n, &a[0][0], lda);
      fclose(in_file);
...
/*       Print input data                                      */
      ...
      PrintBandArrayZ(&order, 0, kl, ku, m, n, &a[0][0], lda, "A");

/*      Call CBLAS_ZGBMV subroutine ( C Interface )                  */
      cblas_zgbmv(order, trans, m, n, kl, ku, &alpha, &a[0][0], lda, 
                  x, incx, &beta, y, incy);
...
void GetInputData(FILE *in_file, int *m, int *n, int *kl, int *ku, 
                  int *incx, int *incy, MKL_Complex16 *alpha, MKL_Complex16 *beta,
