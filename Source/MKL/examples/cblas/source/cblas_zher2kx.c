...
void GetInputData(FILE*, int*, int*, MKL_Complex16*, double*, CBLAS_UPLO*,
...
/*      Call CBLAS_ZHER2K subroutine ( C Interface )                  */
      cblas_zher2k(order, uplo, trans, n, k, &alpha, &a[0][0], lda,
...
/*     Read input data from input file  */
      ...
      fseek(in_file,30,1); 
      fscanf(in_file,"%lf %lf %lf", &(alpha->real), &(alpha->imag),
             beta);
      fseek(in_file,25,1);
