/*
//     S C F F T 1 D C  Example Program Text
...
*/
      ...
      fclose(in_file);
      cblas_scopy(n, r, 1, r0, 1);

/*      Call SCFFT1DC subroutine     */
      SCFFT1DC(r, n, 0, wsave);
      SCFFT1DC(r, n, isign, wsave);  

      printf("\n        S C F F T 1 D C  EXAMPLE PROGRAM");
      printf("\n\n      N=%d  ISIGN=%d", n, isign);
