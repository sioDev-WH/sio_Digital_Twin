*
*     C S F F T 1 D  Example Program Text
*     CopyRight 1999 Intel Corporation
*
      program  CSFFT1D_MAIN
*
      integer     n, isign
	  parameter  (n = 16) 
      integer     rmax, wmax
...
*                                
      print*,'            C S F F T 1 D  EXAMPLE PROGRAM'
...
*        Read input parameters
      ...
      call scopy(n+2, r, 1, r0, 1)

*        Call CSFFT1D subroutine
      call CSFFT1D(r, n, 0, wsave)
