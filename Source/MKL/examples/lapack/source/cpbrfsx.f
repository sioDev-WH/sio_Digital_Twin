*     CPBRFS (F07HVE) Example Program Text
...
*     .. External Subroutines ..
      EXTERNAL         CPBRFS, CPBTRF, CPBTRS, F06TFE, F06THE, X04DBE
*     .. Intrinsic Functions ..
      INTRINSIC        MAX, MIN
*     .. Executable Statements ..
      WRITE (NOUT,*) 'CPBRFS Example Program Results'
...
*
         CALL F06THE('General',KD+1,N,ZERO,ZERO,AB,LDAB)
*
...
*
   ...
   40       CONTINUE
         ...
         CALL F06TFE('General',KD+1,N,AB,LDAB,AFB,LDAFB)
