*     CPTEQR (F08JUE) Example Program Text
...
*     .. External Subroutines ..
      EXTERNAL         CHETRD, CPTEQR, CUNGTR, F06TFE, X04DBE
*     .. Executable Statements ..
      WRITE (NOUT,*) 'CPTEQR Example Program Results'
...
*
         CALL CPTEQR('V',N,D,E,Z,LDZ,RWORK,INFO)
*
         WRITE (NOUT,*)
         IF (INFO.GT.0) THEN
