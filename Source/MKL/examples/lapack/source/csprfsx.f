*     CSPRFS (F07QVE) Example Program Text
...
*     .. External Subroutines ..
      EXTERNAL         CSPRFS, CSPTRF, CSPTRS, F06TFE, X04DBE
*     .. Executable Statements ..
      WRITE (NOUT,*) 'CSPRFS Example Program Results'
...
*
            CALL CSPRFS(UPLO,N,NRHS,AP,AFP,IPIV,B,LDB,X,LDX,FERR,BERR,
     +                  WORK,RWORK,INFO)
*
*           Print solution
*
