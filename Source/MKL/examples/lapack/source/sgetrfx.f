*     SGETRF (F07ADE) Example Program Text
...
*     .. External Subroutines ..
      EXTERNAL         SGETRF, X04CAE
*     .. Intrinsic Functions ..
      INTRINSIC        MIN
*     .. Executable Statements ..
      WRITE (NOUT,*) 'SGETRF Example Program Results'
...
*
         WRITE (NOUT,*)
         IFAIL = 0
         CALL X04CAE('General',' ',M,N,A,LDA,'Details of factorization',
     +               IFAIL)
*
*        Print pivot indices
*
