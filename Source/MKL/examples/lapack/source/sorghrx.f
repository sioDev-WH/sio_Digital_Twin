*     SORGHR (F08NFE) Example Program Text
...
*     .. External Subroutines ..
      EXTERNAL         F06QFE, SGEHRD, SHSEQR, SORGHR, X04CAE
*     .. Executable Statements ..
      WRITE (NOUT,*) 'SORGHR Example Program Results'
...
*        Copy A into Z
*
         CALL F06QFE('General',N,N,A,LDA,Z,LDZ)
*
...
*
         ...
         IFAIL = 0
*
         CALL X04CAE('General',' ',N,N,A,LDA,'Schur form',IFAIL)
*
*        Print Schur vectors
*
         WRITE (NOUT,*)
         IFAIL = 0
*
         CALL X04CAE('General',' ',N,N,Z,LDZ,'Schur vectors of A',IFAIL)
*
      END IF
      STOP
*
