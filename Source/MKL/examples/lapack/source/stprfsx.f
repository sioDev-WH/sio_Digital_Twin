*     STPRFS (F07UHE) Example Program Text
...
*     .. Local Scalars ..
      ...
      CHARACTER        UPLO
*     .. Local Arrays ..
      REAL             AP(NMAX*(NMAX+1)/2), B(LDB,NRHMAX), BERR(NRHMAX),
     +                 FERR(NRHMAX), WORK(3*NMAX), X(LDX,NMAX)
      INTEGER          IWORK(NMAX)
*     .. External Subroutines ..
      EXTERNAL         F06QFE, STPRFS, STPTRS, X04CAE
*     .. Executable Statements ..
      WRITE (NOUT,*) 'STPRFS Example Program Results'
