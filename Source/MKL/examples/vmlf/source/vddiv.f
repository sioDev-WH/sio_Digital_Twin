	...
	MaxRMS=0.0
	do i=1,VEC_LEN
		dA1(i)=VML_DDIV_BEG+((VML_DDIV_END-VML_DDIV_BEG)*i)/VEC_LEN
		dA2(i)=VML_DDIV_BEG+((VML_DDIV_END-VML_DDIV_BEG)*i)/VEC_LEN
		dB1(i)=0;
		dB2(i)=dA1(i)/dA2(i)
	end do

	call VDDIV(VEC_LEN,dA1,dA2(i),dB1)

	print *,"vdDiv test/example programm"
	print *,""
	print *,""
	print *,"           Argument                     vdDiv                      Div"
	print *,"=============================================================================="
	do i=1,VEC_LEN
