	...
	MaxRMS=0.0
	do i=1,VEC_LEN
		dA(i)=VML_DINVSQRT_BEG+((VML_DINVSQRT_END-VML_DINVSQRT_BEG)*i)/VEC_LEN
		dB1(i)=0;
		dB2(i)=1.0/sqrt(dA(i))
	end do

	call VDINVSQRT(VEC_LEN,dA,dB1)

	print *,"vdInvSqrt test/example programm"
	print *,""
	print *,""
	print *,"           Argument                     vdInvSqrt                  1.0/sqrt(x)"
	print *,"=============================================================================="
	do i=1,VEC_LEN
