	...
	MaxRMS=0.0
	do i=1,VEC_LEN
		sA1(i)=VML_SDIV_BEG+((VML_SDIV_END-VML_SDIV_BEG)*i)/VEC_LEN
		sA2(i)=VML_SDIV_BEG+((VML_SDIV_END-VML_SDIV_BEG)*i)/VEC_LEN
		sB1(i)=0;
		sB2(i)=sA1(i)/sA2(i)
	end do

	call VSDIV(VEC_LEN,sA1,sA2,sB1)

	print *,"vsDiv test/example programm"
	print *,""
	print *,""
	print *,"           Argument                     vsDiv                      Div"
	print *,"=============================================================================="
	do i=1,VEC_LEN
