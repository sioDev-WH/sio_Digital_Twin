...
*     .. Executable Statements ..
      CALL CNANCHK('CLEV1','VRON', 1, LEN, 1, CCOMP)
      DO 20 I = 1, LEN
...
99997 FORMAT (1X,I4,I3,3I5,2I36,I12)
      ...
      SUBROUTINE CNANCHK(NAME, OPTS, M, N, LDX, X)
...
*     .. Executable Statements ..
     ...
     $.OR.( IAND( IW( HGHWRD, 2 ), HGHINF ).EQ.HGHINF ) ) CISNAN=.TRUE.
      RETURN
      END
