...
*           Subprogram is not to be tested.
         ...
         ELSE
            SRNAMT = SNAMES( ISNUM )
            print *, ' Testing of function ',srnamt
*           Test error exits.
            IF( TSTERR )THEN
...
*     .. External Functions ..
      ...
      EXTERNAL           LCE, LCERES
*     .. External Subroutines ..
      EXTERNAL           CGBMV, CGEMV, CMAKE, CMVCH, CMKBAD, CFXBAD
*     .. Intrinsic Functions ..
      INTRINSIC          ABS, MAX, MIN
*     .. Scalars in Common ..
      INTEGER            INFOT, NOUTC
...
*        print*,J,A(I,J), ABS1(A(I,J)),ABS1( X( JX )),IY,G(IY)
...
*
      ...
      DO 50 I = 1, ML
         ...
         IF( G( I ).NE.RZERO )
     $      ERRI = ERRI/G( I )
*        print*,I,ERR,ERRI,EPS,SQRT( EPS ),G(I)
         ERR = MAX( ERR, ERRI )
...
*  CMKBAD to generate positive infinity according to IEEE 754 both in
*     imaginary and in real part of a COMPLEX value
*     and
