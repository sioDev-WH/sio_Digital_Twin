...
*     .. External Functions ..
      ...
      EXTERNAL           LDE, LDERES
*     .. External Subroutines ..
      EXTERNAL           DGBMV, DGEMV, DMAKE, DMVCH, DMKBAD, DFXBAD
*     .. Intrinsic Functions ..
      INTRINSIC          ABS, MAX, MIN
*     .. Scalars in Common ..
      INTEGER            INFOT, NOUTC
...
*     to IEEE 754
*     and
*  DFXBAD to check for INF or NaN and if yes, convert it to
*     a "funny" number that hardly can fit the expected result
*
