...
*              .. ISAMAX ..
               CALL SNANCHK('ISAMAX', 'VXIN', 1, LEN, 1, SX)
               CALL ITEST1(ISAMAX(N,SX,INCX),ITRUE2(NP1))
               CALL SNANCHK('ISAMAX', 'VXON', 1, LEN, 1, SX)
            ELSE
...
*     .. Executable Statements ..
*
      CALL SNANCHK('SLEV1', 'VRON', 1, LEN, 1, SCOMP)
      DO 40 I = 1, LEN
         SD = SCOMP(I) - STRUE(I)
...
99997 FORMAT (1X,I4,I3,3I5,2I36,I12)
      ...
      SUBROUTINE SNANCHK(NAME, OPTS, M, N, LDX, X)
...
*     .. Executable Statements ..
      W = X
      SISNAN = .FALSE.
      IF( IAND( IW( HGHWRD ), HGHINF ).EQ.HGHINF ) SISNAN=.TRUE.
      RETURN
      END
...
*     .. Executable Statements ..
      ...
      ENTRY SFXBAD( X )
      W = X
      IF( IAND( IW( HGHWRD ), HGHINF ).EQ.HGHINF ) X = FUNNY
      RETURN
*
