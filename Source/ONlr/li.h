...
LIREAL FAR CALL ONLR_API LiNew (USHORT Prec, register USHORT Size);
 /***********************************************************************
...
INT FAR CALL ONLR_API LiHull (LREAL lb, LREAL hb, LIREAL a, SHORT inner);
 /***********************************************************************
...
INT FAR CALL ONLR_API LiInfSup (LIREAL a, LREAL is, INT is_sup, SHORT inner);
 /***********************************************************************
...
INT FAR CALL ONLR_API LiDiam (LIREAL a, LREAL d, SHORT inner);
 /**************************************************************************
...
INT FAR CALL ONLR_API LiAssign (LIREAL a, LIREAL b, SHORT inner);
 /***********************************************************************
...
INT FAR CALL ONLR_API LiAdd (LIREAL a, LIREAL b, LIREAL c, SHORT inner);
 /***********************************************************************
...
INT FAR CALL ONLR_API LiSub (LIREAL a, LIREAL b, LIREAL c, PVOID wrk, SHORT inner);
 /***********************************************************************
...
INT FAR CALL ONLR_API LiMul (LIREAL a, LIREAL b, LIREAL c, PVOID wrk, SHORT inner);
 /***********************************************************************
...
INT FAR CALL ONLR_API LiNeg (LIREAL a, LIREAL b);
 /***********************************************************************
...
USHORT FAR CALL ONLR_API litoszf (
...
INT FAR CALL ONLR_API lisztoli (
