...
extern INT FAR ONLR_API dtolr (LREAL lr, PDOUBLE a);
  /**********************************************************************
...
extern INT FAR ONLR_API lrtod (PDOUBLE a, LREAL lr, USHORT rnd);
  /**********************************************************************
...
extern INT FAR ONLR_API ddtolr (DOUBLE a, DOUBLE b, LREAL lr);
  /**********************************************************************
...
extern ONLR_API VOID FAR CALL LrInit ARGS ((VOID));
  /**********************************************************************
...
LREAL FAR CALL ONLR_API LrNew ARGS ((SIZE Digits, SIZE Size));
  /**********************************************************************
...
extern INT FAR CALL ONLR_API dtolr ARGS ((LREAL res, PDOUBLE dble));
  /**********************************************************************
  *  Funktion :	Konvertierung: DOUBLE -> LREAL
  *  Speicher :	Bedarf fuer "res" in Bytes:
  *		  sizeof (LREALHDR) + 6	* sizeof (LDIGIT)
...
extern INT FAR ONLR_API ddtolr ARGS ((DOUBLE a, DOUBLE b, LREAL lr));
  /**********************************************************************
  *  Funktion : Exakte Multiplikation zweier DOUBLE-Zahlen und Speicherung
  *		als Langzahl.
  *  Speicher : Bedarf fuer "lr" in Bytes:
...
extern INT FAR CALL ONLR_API lrtod ARGS ((PDOUBLE dble, LREAL lr, INT Rnd));
  /**********************************************************************
  *  Funktion :	Konvertierung: LREAL ->	DOUBLE
  *  Eingaben :	Rnd	: Rundung
  *		    LR_RND_NEAR	: zur naechsten		 DOUBLE-Zahl
...
extern INT FAR CALL ONLR_API lrsztolr ARGS ((PCHAR pchIn, PPCHAR pchOut, LREAL c,
...
extern PCHAR FAR CALL ONLR_API lrtosze ARGS ((
...
extern INT FAR CALL ONLR_API LrAssign ARGS ((LREAL a, LREAL b, INT Level));
  /**********************************************************************
...
extern INT FAR CALL ONLR_API LrPred ARGS ((LREAL a, SHORT Digits));
  /**********************************************************************
...
extern INT FAR CALL ONLR_API LrSucc ARGS ((LREAL a, SHORT Digits));
  /**********************************************************************
...
extern INT FAR CALL ONLR_API LrAdd ARGS ((LREAL a, LREAL b, LREAL c, INT Level));
  /**********************************************************************
...
extern INT FAR CALL ONLR_API LrSub ARGS ((LREAL a, LREAL b, LREAL c, INT Level));
  /**********************************************************************
...
extern INT FAR CALL ONLR_API LrMul ARGS ((LREAL a, LREAL b, LREAL c, INT Level));
  /**********************************************************************
...
extern INT FAR CALL ONLR_API LrDiv ARGS ((
...
extern INT FAR CALL ONLR_API LrScalp ARGS ((
